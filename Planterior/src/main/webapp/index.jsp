                ...
                <div class="col-8 col-xs-12" style="padding: 50px 0;">
                    <div class="box-slider"
                        ...
                        <div class="row" style="height: 100%;">
                            ...
                            <%
                            	Optional<Product> prodotto1 = ProductDao.getInstance().getById(41);
                           	 	Optional<Product> prodotto2 = ProductDao.getInstance().getById(42);
                            	Optional<Product> prodotto3 = ProductDao.getInstance().getById(43);
