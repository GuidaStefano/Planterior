    ...
    <body>
        ...
        <div class="product-card">
            <div class="product-image">
                <img id="main-image" src=<%= PathUtil.getMainImagePath(product.getId()) %> alt="Product Image">
            ...
            <div class="product-details">
                ...
                <div class="number-input-wrapper">
	                <form class="form" action="Carrello" method="GET"> 
	                    ...
	                    <button type="submit" class="big-button static-btn"><h6 style="margin: 12px 30px;">AGGIUNGI AL CARRELLO</h6></button>
	                 </form>   
                </div>
            </div>
        ...
        <script>
        	$(document).ready(function(){
          	   var quantity = <%= product.getAvailableAmount() %>;
          	  $("#up").click(function(){
